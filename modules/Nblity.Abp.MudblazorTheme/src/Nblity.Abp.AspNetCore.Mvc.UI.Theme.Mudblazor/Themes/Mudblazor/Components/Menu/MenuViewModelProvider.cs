...
public class MenuViewModelProvider : ITransientDependency
{
	...
	protected IObjectMapper<AbpAspNetCoreMvcUiMudblazorThemeModule> ObjectMapper { get; }

	public MenuViewModelProvider(IMenuManager menuManager, IPageLayout pageLayout, IObjectMapper<AbpAspNetCoreMvcUiMudblazorThemeModule> objectMapper)
	{
