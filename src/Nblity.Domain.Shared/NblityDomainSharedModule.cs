...
public class NblityDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        NblityGlobalFeatureConfigurator.Configure();
        NblityModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<NblityDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<NblityResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Nblity");

            options.DefaultResourceType = typeof(NblityResource);
        ...
        {
            options.MapCodeNamespace("Nblity", typeof(NblityResource));
        });
    }
}
