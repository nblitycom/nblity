...
public class NblityDbContext :
    AbpDbContext<NblityDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public NblityDbContext(DbContextOptions<NblityDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(NblityConsts.DbTablePrefix + "YourEntities", NblityConsts.DbSchema);
